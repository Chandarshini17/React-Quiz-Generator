...
const Quiz = () => {
    ...
    const apiUrl = "https://opentdb.com/api.php?amount=50&category=12&difficulty=medium&encode=url3986";
useEffect(() => {
        ...
        <div className="quiz">
            {quizState.showResults && (
                <div className='results'>
                    ...
                    <div className='next-button'onClick={() => dispatch
                    ({type: "RESTART"})}>Restart</div>
                </div>
            )}
